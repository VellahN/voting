                         ...
                         <form method = "post" enctype = "multipart/form-data">
                                ...
                                <div class="form-heading">
                         		<center>Voter Registeration</center>
											...
											<div class="form-field">
												<label>Program of Study <i>(enter initials only i.e BBIT,BIRD, BIT..)</i></label><br/>
													<input class="form-control"  type = "text" name = "prog_study" placeholder="E.g BIT, BIRD,CIT, BHM" required="true">
											</div>
